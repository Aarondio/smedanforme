            ...
            <div class="container py-10 py-md-12">
                <div class="row">
                    <div class="col-lg-10 col-xxl-8 ">
                        <h1 class="display-2 mb-1 text-white">A new way to Evaluate the feasibility and sustainability of
                            your business.</h1>
                    </div>
                    <!-- /column -->
                </div>
                ...
                <div class="col-md-4 mt-5">
                    <div class="card p-0">
                        <div class="card-header px-5 bg-purple text-white py-1">
                            <p class="text-white p-0 m-0"> <span class="display-6"> 2. </span> Answer Simple Questions</p>
                        </div>
                        <div class="card-body px-5 p-0 pt-2">
                            <p>Create a secure account</p>
                        </div>
