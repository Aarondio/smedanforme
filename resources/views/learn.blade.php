        ...
        <div class="container pt-13 pb-15 pt-md-15 pb-md-16 text-center">
            ...
            <div class="row mb-11">
                <div class="col-md-3 col-lg-3 col-xxl-3 mx-auto mt-3" data-cues="zoomIn" data-group="page-title"
                    ...
                    <div class="card px-0">
                        <div class="card-body text-center px-0">
                            <img src="{{asset('assets/img/icons/lineal/paper.svg')}}"  class="svg-inject icon-svg icon-svg-sm text-primary" alt="" />
                ...
                <div class="col-md-3 col-lg-3 col-xxl-3 mx-auto mt-3" data-cues="zoomIn" data-group="page-title"
                    ...
                    <div class="card px-0">
                        <div class="card-body text-center px-0">
                            <img src="{{asset('assets/img/icons/lineal/list.svg')}}" class="svg-inject icon-svg icon-svg-sm text-primary" alt="" />
                ...
                <div class="col-md-3 col-lg-3 col-xxl-3 mx-auto mt-3" data-cues="zoomIn" data-group="page-title"
                    ...
                    <div class="card px-0">
                        <div class="card-body text-center px-0">
                            <img src="{{asset('assets/img/icons/lineal/briefcase-2.svg')}}" class="svg-inject icon-svg icon-svg-sm text-primary" alt="" />
                ...
                <div class="col-md-3 col-lg-3 col-xxl-3 mx-auto mt-3" data-cues="zoomIn" data-group="page-title"
                    ...
                    <div class="card px-0">
                        <div class="card-body text-center px-0">
                            <img src="{{asset('assets/img/icons/lineal/light-bulb.svg')}}" class="svg-inject icon-svg icon-svg-sm text-primary" alt="" />
