...
<head>
    <meta charset="utf-8" />
    <title>Smedan Data center</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="Data center." name="description" />
        ...
        <div class="navbar-custom">
            <div class="topbar container-fluid">
                ...
                <ul class="topbar-menu d-flex align-items-center gap-3">
                    ...
                    @if (Auth::guard('staff')->user()->staff_type == 3)
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 text-truncate ms-2">
                                                    <h5 class="noti-item-title fw-semibold fs-14">Datacorp <small
                                                            class="fw-normal text-muted float-end ms-1">1 min
                                                            ago</small>
                                                    </h5>
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 text-truncate ms-2">
                                                    <h5 class="noti-item-title fw-semibold fs-14">Admin <small
                                                            class="fw-normal text-muted float-end ms-1">1 hr
                                                            ago</small>
                                                    </h5>
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 text-truncate ms-2">
                                                    <h5 class="noti-item-title fw-semibold fs-14">Cristina Pride <small
                                                            class="fw-normal text-muted float-end ms-1">1 day
                                                            ago</small>
                                                    </h5>
                    ...
                    <li class="dropdown">
                        <a class="nav-link dropdown-toggle arrow-none nav-user px-2" data-bs-toggle="dropdown"
                            ...
                            <span class="d-lg-flex flex-column gap-1 d-none">
                                <h5 class="my-0">{{ Auth::guard('staff')->user()->name }}</h5>
                                <h6 class="my-0 fw-normal">
                                    @if (Auth::guard('staff')->user()->staff_type == 1)
                                        Staff
                                    @else
                                        ICT Head
                                    @endif
                        ...
                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated profile-dropdown">
                            ...
                            <!-- item-->
                            <a href="{{ route('profile', Auth::guard('staff')->user()->id) }}" class="dropdown-item">
                                <i class="ri-account-circle-line fs-18 align-middle me-1"></i>
                                <span>My Account</span>
                            </a>

                            <!-- item-->
                            @if (Auth::guard('staff')->user()->staff_type == 3 || Auth::guard('staff')->user()->staff_type == 2)
                            ...
                            <form action="{{ route('staff.logout') }}" method="post" class="dropdown-item">
                                @csrf
                                <i class="ri-logout-box-line fs-18 align-middle me-1 text-danger"></i>
                                <button class="btn btn-link p-0 m-0 text-danger" type="submit"> Logout</button>
                            </form>
                        </div>
                    </li>
                </ul>
        ...
        <div class="leftside-menu">
            ...
            <div class="h-100" id="leftside-menu-container" data-simplebar>
                ...
                <ul class="side-nav">
                    ...
                    @if (Auth::guard('staff')->user()->staff_type == 3 || Auth::guard('staff')->user()->staff_type == 2)
                        <li class="side-nav-item">
                            <a href="{{ route('staff') }}" class="side-nav-link">
                    ...
                    <li class="side-nav-item">
                        ...
                        <div class="collapse" id="sidebarEmail">
                            <ul class="side-nav-second-level">
                                ...
                                <li>
                                    <a href="{{ route('reviewed') }}">Qualified</a>
                                </li>
                                <li>
                                    <a href="{{ route('disqualified') }}">Disqualified</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="side-nav-title">Settings and History</li>

                    @if (Auth::guard('staff')->user()->staff_type == 3)
                        <li class="side-nav-item">
                            <a href="{{ route('campaign') }}" class="side-nav-link">
                    ...
                    @if (Auth::guard('staff')->user()->staff_type == 3)
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarExtendedUI">
                                <ul class="side-nav-second-level">
                                    <li>
                                        <a href="extended-dragula.html">Matching Funds 2022</a>
                                    </li>
