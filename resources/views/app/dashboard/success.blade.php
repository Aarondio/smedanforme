        ...
        <div class="container py-14 py-md-16">
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-body">
                            <center><img src="{{ asset('assets/img/success.gif') }}" class="text-center" width="100"
                                    alt=""></center>
                            ...
                            <p class="text-center ">All submitted application will be available on your dashboard</p>
                        </div>
                    </div>
                </div>
            </div>
