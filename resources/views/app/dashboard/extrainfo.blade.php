            ...
            <div class="row justify-content-center ">
                <div class="col-md-10 card shadow-lg">
                    <div class="card-body">
                        ...
                        <h2>Product information for {{ $product->name }} - Annual record</h2>
                        ...
                        <form action="{{ route('saveproductioncost') }}" method="POST">
                            ...
                            <input type="text" name="salesid" value="{{ $existingSalesForecast->id }}" hidden>
                            <div class="row text-dark">
                                <div class="col-md-4">

                                    <div class=" mb-4">
                                        <label for="jan_price" class="mb-3">Product price in January</label>
                                        <input id="jan_price" name="jan_price"
                                            value="{{ $existingSalesForecast->jan_price ?? '' }}" type="text"
                                            value="" class="form-control" placeholder="Price in january" required>
                                        @error('name')
                                            <p class="small text-danger"> </p>
                                        @enderror
                                    </div>
                                    <div class="form-check mt-2">
                                        <input class="form-check-input" type="checkbox" name="proprice" value=""
                                            id="proprice">
                                        <label class="form-check-label small" for="proprice"> Click on the check box if
                                            the
                                            price of product is the same from <b>January</b> to <b>December</b>.
                                        </label>
                                    </div>
                                    ...
                                    <div id="collapse-price"
                                        ...
                                        <div class="code-wrapper">
                                            <div class=" mb-2">
                                                ...
                                                <input id="feb_price" name="feb_price" type="number"
                                                    value="{{ $existingSalesForecast->feb_price ?? '' }}"
                                            ...
                                            <div class=" mb-2">
                                                ...
                                                <input id="mar_price" name="mar_price" type="number"
                                                    value="{{ $existingSalesForecast->mar_price ?? '' }}"
                                            ...
                                            <div class=" mb-2">
                                                ...
                                                <input id="apr_price" name="apr_price" type="number"
                                                    value="{{ $existingSalesForecast->apr_price ?? '' }}"
                                            ...
                                            <div class=" mb-2">
                                                ...
                                                <input id="may_price" name="may_price" type="number"
                                                    value="{{ $existingSalesForecast->may_price ?? '' }}"
                                            ...
                                            <div class=" mb-2">
                                                ...
                                                <input id="jun_price" name="jun_price" type="number"
                                                    value="{{ $existingSalesForecast->jun_price ?? '' }}"
                                            ...
                                            <div class=" mb-2">
                                                ...
                                                <input id="jul_price" name="jul_price" type="number"
                                                    value="{{ $existingSalesForecast->jul_price ?? '' }}"
                                            ...
                                            <div class=" mb-2">
                                                ...
                                                <input id="aug_price" name="aug_price" type="number"
                                                    value="{{ $existingSalesForecast->aug_price ?? '' }}"
                                            ...
                                            <div class=" mb-2">
                                                <label for="sep_price" class="">price of producing in
                                                    September</label>
                                                <input id="sep_price" name="sep_price" type="number"
                                                    value="{{ $existingSalesForecast->sep_price ?? '' }}"
                                            ...
                                            <div class=" mb-2">
                                                <label for="oct_price" class="">price of producing in
                                                    October</label>
                                                <input id="oct_price" name="oct_price" type="number"
                                                    value="{{ $existingSalesForecast->oct_price ?? '' }}"
                                            ...
                                            <div class=" mb-2">
                                                <label for="nov_price" class="">price of producing in
                                                    November</label>
                                                <input id="nov_price" name="nov_price" type="number"
                                                    value="{{ $existingSalesForecast->nov_price ?? '' }}"
                                            ...
                                            <div class=" mb-2">
                                                <label for="dec_price" class="">price of producing in
                                                    November</label>
                                                <input id="dec_price" name="dec_price" type="number"
                                                    value="{{ $existingSalesForecast->dec_price ?? '' }}"
                                ...
                                <div class="col-md-4">
                                    <div class=" mb-4">
                                        ...
                                        <input id="jan_cost" name="jan_cost" type="number"
                                            value="{{ $existingSalesForecast->jan_cost ?? '' }}" class="form-control"
                                            placeholder="January cost">
                                        @error('jan_cost')
                                            <p class="small text-danger"> {{ $message }}</p>
                                        @enderror
                                    </div>
                                    <div class="form-check mt-2">
                                        <input class="form-check-input" type="checkbox" name="procost" id="procost">
                                        <label class="form-check-label small" for="procost"> Click on the check box if
                                            the cost of production is the same from <b>January</b> to <b>December</b>.
                                        </label>
                                    </div>
                                    ...
                                    <div id="collapse-cost"
                                        ...
                                        <div class="code-wrapper">
                                            <div class=" mb-2">
                                                ...
                                                <input id="feb_cost" name="feb_cost" type="number"
                                                    value="{{ $existingSalesForecast->feb_cost ?? '' }}"
                                            ...
                                            <div class=" mb-2">
                                                ...
                                                <input id="mar_cost" name="mar_cost" type="number"
                                                    value="{{ $existingSalesForecast->mar_cost ?? '' }}"
                                            ...
                                            <div class=" mb-2">
                                                ...
                                                <input id="apr_cost" name="apr_cost" type="number"
                                                    value="{{ $existingSalesForecast->apr_cost ?? '' }}"
                                            ...
                                            <div class=" mb-2">
                                                ...
                                                <input id="may_cost" name="may_cost" type="number"
                                                    value="{{ $existingSalesForecast->may_cost ?? '' }}"
                                            ...
                                            <div class=" mb-2">
                                                ...
                                                <input id="jun_cost" name="jun_cost" type="number"
                                                    value="{{ $existingSalesForecast->jun_cost ?? '' }}"
                                            ...
                                            <div class=" mb-2">
                                                ...
                                                <input id="jul_cost" name="jul_cost" type="number"
                                                    value="{{ $existingSalesForecast->jul_cost ?? '' }}"
                                            ...
                                            <div class=" mb-2">
                                                ...
                                                <input id="aug_cost" name="aug_cost" type="number"
                                                    value="{{ $existingSalesForecast->aug_cost ?? '' }}"
                                            ...
                                            <div class=" mb-2">
                                                <label for="sep_cost" class="">Cost of producing in
                                                    September</label>
                                                <input id="sep_cost" name="sep_cost" type="number"
                                                    value="{{ $existingSalesForecast->sep_cost ?? '' }}"
                                            ...
                                            <div class=" mb-2">
                                                ...
                                                <input id="oct_cost" name="oct_cost" type="number"
                                                    value="{{ $existingSalesForecast->oct_cost ?? '' }}"
                                            ...
                                            <div class=" mb-2">
                                                ...
                                                <input id="nov_cost" name="nov_cost" type="number"
                                                    value="{{ $existingSalesForecast->nov_cost ?? '' }}"
                                            ...
                                            <div class=" mb-2">
                                                ...
                                                <input id="dec_cost" name="dec_cost" type="number"
                                                    value="{{ $existingSalesForecast->dec_cost ?? '' }}"
                                ...
                                <div class="col-md-4">
                                    <div class=" mb-4">
                                        ...
                                        <input id="jan_qty" name="jan_qty" type="number" value="{{ $existingSalesForecast->jan_qty ?? '' }}"
                                    ...
                                    <div class="form-check mt-2">
                                        <label class="form-check-label small">Click on Other months to add the quantity
                                            sold
                                            from <b>Febuary</b> to <b>December</b>. </label>
                                    </div>
                                    ...
                                    <div id="collapse-qty"
                                        ...
                                        <div class="code-wrapper">
                                            <div class=" mb-2">
                                                ...
                                                <input id="feb_qty" name="feb_qty" type="number" value="{{ $existingSalesForecast->feb_qty ?? '' }}"
                                            ...
                                            <div class=" mb-2">
                                                ...
                                                <input id="mar_qty" name="mar_qty" type="number" value="{{ $existingSalesForecast->mar_qty ?? '' }}"
                                            ...
                                            <div class=" mb-2">
                                                ...
                                                <input id="apr_qty" name="apr_qty" type="number" value="{{ $existingSalesForecast->apr_qty ?? '' }}"
                                            ...
                                            <div class=" mb-2">
                                                ...
                                                <input id="may_qty" name="may_qty" type="number" value="{{ $existingSalesForecast->may_qty ?? '' }}"
                                            ...
                                            <div class=" mb-2">
                                                ...
                                                <input id="jun_qty" name="jun_qty" type="number" value="{{ $existingSalesForecast->jun_qty ?? '' }}"
                                            ...
                                            <div class=" mb-2">
                                                ...
                                                <input id="jul_qty" name="jul_qty" type="number" value="{{ $existingSalesForecast->jul_qty ?? '' }}"
                                            ...
                                            <div class=" mb-2">
                                                ...
                                                <input id="aug_qty" name="aug_qty" type="number" value="{{ $existingSalesForecast->aug_qty ?? '' }}"
                                            ...
                                            <div class=" mb-2">
                                                ...
                                                <input id="sep_qty" name="sep_qty" type="number" value="{{ $existingSalesForecast->sep_qty ?? '' }}"
                                            ...
                                            <div class=" mb-2">
                                                ...
                                                <input id="oct_qty" name="oct_qty" type="number" value="{{ $existingSalesForecast->oct_qty ?? '' }}"
                                            ...
                                            <div class=" mb-2">
                                                ...
                                                <input id="nov_qty" name="nov_qty" type="number" value="{{ $existingSalesForecast->nov_qty ?? '' }}"
                                            ...
                                            <div class=" mb-2">
                                                <label for="dec_qty" class="">Quantity sold in in December</label>
                                                <input id="dec_qty" name="dec_qty" type="number" value="{{ $existingSalesForecast->dec_qty ?? '' }}"
