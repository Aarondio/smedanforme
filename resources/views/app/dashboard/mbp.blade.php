        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-8">
                    <ul class="nav nav-tabs m-0 p-0  nav-tabs-bg nav-tabs-shadow-lg d-flex justify-content-center  flex-lg-row flex-column  ">
                        ...
                        <li class="nav-item  m-0 bg-gray "> 
                          <a class="nav-link d-flex flex-row rounded-0 active  justify-content-center" data-bs-toggle="tab" href="#tab2-3">
            ...
            <center>
                ...
                <div class="tab-content">
                        ...
                        <div class="col-md-6 col-lg-3 mt-12">
                            <div class="pricing card text-center">
                              <div class="card-body">
                                ...
                                <a href="#" class="btn btn-grape disabled rounded-pill">Compare</a>
                              </div>
                              <!--/.card-body -->
                            </div>
                            <!--/.pricing -->
                    ...
                    <div class="tab-pane fade show active" id="tab2-3">
                        <div class="col-md-6 col-lg-3 mt-12">
                            <div class="pricing card text-center">
                              <div class="card-body">
                                <img src="{{asset('asset/img/icons/lineal/briefcase-2.svg')}}" class="svg-inject icon-svg icon-svg-md text-primary mb-3" alt="" />
                                ...
                                <a href="https://paystack.com/pay/smecredits" class="btn btn-grape rounded-pill disabled">Pay
                                  now</a>
                              </div>
                              <!--/.card-body -->
                            </div>
