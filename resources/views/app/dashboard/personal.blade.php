                            ...
                            <div class="row text-dark">
                                <div class="col-md-6">
                                    <div class=" mb-4">
                                        ...
                                        <input id="firstname" name="firstname" type="text"
                                            value="{{ old('firstname') ?: ($user->firstname ?? '') }}" class="form-control @error('firstname') is-invalid @enderror"
                                ...
                                <div class="col-md-6">
                                    <div class=" mb-4">
                                        ...
                                        <input id="surname" name="surname" type="text"
                                            value="{{ old('surname') ?: ($user->surname ?? '') }}" class="form-control @error('surname') is-invalid @enderror" placeholder="Surname">
                                        {{-- @error('surname')
                                            <p class="small text-danger"> {{ $message }}</p>
                                        @enderror --}}
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class=" mb-4">
                                        ...
                                        <input id="middlename" name="middlename" value="{{ old('middlename') ?: ($user->middlename ?? '') }}"
                                            type="text" class="form-control @error('middlename') is-invalid @enderror" placeholder="Middle name">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class=" mb-4">
                                ...
                                <div class="col-md-6">
                                    <div class=" mb-4">
                                        <div class="form-select-wrapper mb-4">
                                            ...
                                            <select class="form-select @error('gender') is-invalid @enderror" name="gender" id="gender" aria-label="gender">
                                                <option disabled {{ old('gender', $user->gender) ? '' : 'selected' }}>Select Gender</option>
                                    ...
                                    <div class=" mb-4">
                                        <div class="form-select-wrapper mb-4">
                                            ...
                                            <select class="form-select @error('marital_status') is-invalid @enderror" name="marital_status" id="marital_status"
                                                ...
                                                <option disabled {{ old('marital_status', $user->marital_status) ? '' : 'selected' }}>Select Marital Status</option>
                                ...
                                <div class="col-md-6">
                                    <div class=" mb-4">
                                        ...
                                        <input id="nationality" name="nationality"
                                            value="{{ old('nationality') ?: ($user->nationality ?? '') }}" type="text" class="form-control @error('nationality') is-invalid @enderror"
                                ...
                                <div class="col-md-6">
                                    <div class=" mb-4">
                                        ...
                                        <textarea id="address" name="address" class="form-control @error('address') is-invalid @enderror" rows="5" placeholder="Address (with landmarks)"
